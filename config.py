...
def get_pool_config(token_in_symbol, token_out_symbol, fee=None, w3=None, auto_discover=True):
    """
...
LIQUIDITY_TIERS = {
    "high": [
        ...
        "LINK", "UNI", "MATIC", "AAVE", "CRV", "MKR",
        "SNX", "COMP", "LDO", "PEPE", "SHIB", "APE",
        "GRT", "FXS", "STG"
    ],
    "medium": [
        "RPL", "BAL", "ENJ", "YFI", "BAT", "ZRX",
        "INJ", "CVX", "ANKR", "LRC", "BNT", "ALCX"
    ],
    "low": [
        "FLOKI", "BLUR", "LOOKS", "IMX", "SAND", "MANA",
        "AXS", "GMT", "GALA", "ENS", "MASK", "RNDR",
        "FET", "AGIX", "OCEAN", "WLD", "DYDX", "BONE",
        "SUSHI", "1INCH"
    ]
}
